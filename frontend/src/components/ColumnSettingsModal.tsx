...
const formatColumnName = (key: string, t: (key: string) => string): string => {
  const nameMap: { [key: string]: string } = {
    ...
    calculation_sheet_no: t("concentration.calcSheetNo"),
    drawing_no: t("concentration.drawingNoLabel"),
    invoice_description: t("concentration.invoiceDescriptionLabel"),
    drawings: t("concentration.drawings"),
    estimated_quantity: t("concentration.estQuantity"),
    submission_percentage: t("concentration.submissionPercentage"),
    quantity_submitted: t("concentration.qtySubmitted"),
    internal_quantity: t("concentration.internalQty"),
    approved_qty: t("concentration.approvedQty"),
    notes: t("boq.notes"),
    supervisor_notes: t("concentration.supervisorNotes"),
    actions: t("concentration.actions"),
